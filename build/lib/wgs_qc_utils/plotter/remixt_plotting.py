...
def plot(prepped_remixt, axis, chrom_max, logistic_y=False):
    """
    ...
    if logistic_y:
        ...
        maj = squash_f(prepped_remixt.major_raw) * 3
        min = squash_f(prepped_remixt.minor_raw) * 3
        ...
        maj = prepped_remixt.major_raw * 3
        min = prepped_remixt.minor_raw * 3
