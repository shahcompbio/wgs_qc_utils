...
def plot_chrom_on_axes(remixt, titan, roh, germline_calls, somatic_calls,
    ...
    prepped_tumour_coverage = coverage_plotting.prepare_at_chrom(tumour_coverage, chrom, bin=False, n_bins=2000)
    ...
    axes[7] = roh_plotting.plot(prepped_roh, axes[7], chrom_max)
